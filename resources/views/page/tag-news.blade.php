                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    ...
                                    <a href="#" class="blog_item_date">
                                        <h3><i class="fa fa-tag"> </i> {{$tg}}</h3>
                                    </a>
                                </div>

                                <div class="blog_details">
                                    <a class="d-inline-block" href="tin-tuc/{{$nf->id}}/{{$nf->TieuDeKhongDau}}.html">
                                        <h2>{{$nf->TieuDe}}</h2>
                                    </a>
                                    <p>{!! $nf->TomTat !!}</p>
                                    <ul class="blog-info-link">
                                        <li><a href="#"><i class="fa fa-user"></i> {{$nf->typeNews->Ten}}</a></li>
                                        <li><a href="#"><i class="fa fa-comments"></i> {{count($nf->comment)}}</a></li>
                                    </ul>
                                </div>
                            </article>
                        @endforeach
