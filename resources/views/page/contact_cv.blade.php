        ...
        <div class="profile-page">
            <div class="wrapper">
                <div class="page-header page-header-small" filter-color="green">
                    <div class="page-header-image" data-parallax="true"><img height="100%" src="{{asset('assets/images-cv/cc-bg-1.jpg')}}" alt="Image"/></div>
                    <div class="container">
                        <div class="content-center">
                            <div class="cc-profile-image"><a href="#"><img src="{{asset('assets/images-cv/face.jpg')}}" alt="Image"/></a></div>
                            <div class="h2 title">Phan Thanh Huy</div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="card-body">
                                ...
                                <p>Hello! I am Huy. Web Developer, Graphic Designer and Photographer.</p>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-sm-8">phanthanhhuyguitar@gmail.com</div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
                                    <div class="col-sm-8">+9418-111-0011</div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-sm-4"><strong class="text-uppercase">Address:</strong></div>
                                    <div class="col-sm-8">Hoàng Mai - Hà Nội</div>
                                </div>
                                <div class="row mt-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                                            <figure class="cc-effect"><img src="{{asset('assets/images-cv/project-1.jpg')}}" alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                                            <figure class="cc-effect"><img src="{{asset('assets/images-cv/project-2.jpg')}}" alt="Image"/>
                                                <figcaption>
                                ...
                                <div class="col-md-6">
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                                            <figure class="cc-effect"><img src="{{asset('assets/images-cv/project-3.jpg')}}" alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                                            <figure class="cc-effect"><img src="{{asset('assets/images-cv/project-4.jpg')}}" alt="Image"/>
                                                <figcaption>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                                            <figure class="cc-effect"><img src="{{asset('assets/images-cv/graphic-design-1.jpg')}}" alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                                            <figure class="cc-effect"><img src="{{asset('assets/images-cv/graphic-design-2.jpg')}}" alt="Image"/>
                                                <figcaption>
                                ...
                                <div class="col-md-6">
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                                            <figure class="cc-effect"><img src="{{asset('assets/images-cv/graphic-design-3.jpg')}}" alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                                            <figure class="cc-effect"><img src="{{asset('assets/images-cv/graphic-design-4.jpg')}}" alt="Image"/>
                                                <figcaption>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#Photography">
                                            <figure class="cc-effect"><img src="{{asset('assets/images-cv/photography-1.jpg')}}" alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#Photography">
                                            <figure class="cc-effect"><img src="{{asset('assets/images-cv/photography-3.jpg')}}" alt="Image"/>
                                                <figcaption>
                                ...
                                <div class="col-md-6">
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#Photography">
                                            <figure class="cc-effect"><img src="{{asset('assets/images-cv/photography-2.jpg')}}" alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#Photography">
                                            <figure class="cc-effect"><img src="{{asset('assets/images-cv/photography-4.jpg')}}" alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card-body">
                                                ...
                                                <p class="pb-2">Hoàng Mai - Hà Nội</p>
                                                <p class="mb-0"><strong>Phone</strong></p>
                                                <p class="pb-2">+8418-111-0011</p>
                                                <p class="mb-0"><strong>Email</strong></p>
                                                <p>phanthanhhuyguitar@gmail.com</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script src="{{asset('assets/js-cv/core/jquery.3.2.1.min.js')}}"></script>
<script src="{{asset('assets/js-cv/core/popper.min.js')}}"></script>
<script src="{{asset('assets/js-cv/core/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/js-cv/now-ui-kit.js?v=1.1.0')}}"></script>
<script src="{{asset('assets/js-cv/aos.js')}}"></script>
<script src="{{asset('assets/scripts-cv/main.js')}}"></script>
</body>
</html>
